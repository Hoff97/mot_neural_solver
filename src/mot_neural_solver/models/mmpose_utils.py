...
def inference(model, dataloader, return_heatmap=False, beautify_results=True, debug=False):
    """
    ...
    for data in tqdm(dataloader):
        ...
        # show image with bbox for debugging
        if debug:
            img_meta = get_image_meta(data)
